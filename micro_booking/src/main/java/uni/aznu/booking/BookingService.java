...
//	}
	...
	private void gateway() {
		...
		rest("/process").description("Micro booking REST service")
		.consumes("application/json")
		.produces("application/json")
		.post("/booking")
				.description("Book an equipment")
				.type(BookProcessRequest.class)
				.outType(BookingInfo.class)
...
//		from("direct:BookProcessRequest").routeId("BookProcessRequest")
...
//		;
//
//		from("kafka:BookingFailTopic?brokers=localhost:9092").routeId("bookEquipmentCompensation")
...
//					 BookingInfo BookingInfo = Utils.prepareBookingInfo(bookingId, totalCost);
